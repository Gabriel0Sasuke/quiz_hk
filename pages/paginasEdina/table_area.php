...
<body>
    ...
    <main>
        ...
        if($resultados->num_rows == 0){
            echo "<h2 style='margin-top: 5vh;'>Nenhuma área cadastrada.</h2>";
        } else {
    ...
    <table>
        ...
        <tr>
            ...
            <td><button class="btn" onclick="confirmarDelete(<?php echo $row['area_id']; ?>)">Deletar</button></td>
        </tr>
        <?php } ?>
    </table>
    <?php } ?>
  ...
  if (result.isConfirmed) {
    window.location.href = baseUrl + "scripts/scriptsEdina/deletar_area.php?id=" + id;
  }
});
        }
    </script>
        ...
        <?php if(isset($_SESSION['msg_id'])) { 
            ...
            switch($msg_id){
                case 0:
                    ...
                    'Swal.fire({
                        title: "Sucesso!",
                        text: "Área deletada com sucesso.",
                        icon: "success"
                    });';
                    break;
                case 1:
